...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sx9msaa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sx9msaa.containers.anotherwebservice.com/
...
```
git clone git@github.com:mojtabatavakolzadeh/container-sx9msaa.git
cd container-sx9msaa
```
...
```
docker attach container-sx9msaa
```
